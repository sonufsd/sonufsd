...
const socialMetadata = {
  ...
  generalKeywords: [
    ...
    "systems developer",
    "Full Stack Java Spring Boot Angular Developer",
    "Full Stack Java Spring Boot React.js Developer",
    "Java Spring Boot Microservices with Angular Frontend",
    "React.js Frontend with Java Spring Boot Backend",
    "Enterprise Java Full Stack with Spring Boot and Angular 17+",
    "Scalable Full Stack Development using Java, Spring Boot, and React",
  ],
  ...
  industryKeywords: [
    ...
    "agile development",
    "Java 21 Full Stack Developer with Spring Boot 3.x and Angular",
    "Spring Security and OAuth 2.0 in Java Full Stack Applications",
    "Microservices Architecture with Spring Boot and React/Angular",
    "RESTful API Design and Implementation with Java Spring Boot",
    "Hibernate ORM and Spring Data JPA for Java Full Stack",
    "Frontend Development with Angular, NgRx, and RxJs",
    "React.js State Management with Redux in Java Full Stack",
    "UI/UX Design Principles for Angular/React with Java Backend",
  ],
  ...
  enhancedOpenGraph: {
    title:
      "Sonu Kumar - Senior Full Stack Developer | Enterprise Solutions Expert",
    description:
      "Senior Full Stack Developer with 7.5+ years experience. Expert in Java, Spring Boot, Angular, React. Delivered solutions for Fortune 500 companies. Available for remote work opportunities.",
  ...
  twitterCard: {
    ...
    creator: "@sonuskr",
    title:
      "Sonu Kumar - Senior Full Stack Developer | Java Spring Boot Angular React Expert",
    description:
      "Senior Full Stack Developer with 7.5+ years experience building enterprise applications. Expert in Java, Spring Boot, Angular, React, TypeScript. Available for remote work.",
  ...
  enhancedSchema: {
    ...
    description:
      "Experienced Senior Full Stack Developer specializing in enterprise web applications, microservices architecture, and modern JavaScript frameworks. Expert in Java Spring Boot, Angular, React, and cloud technologies.",
